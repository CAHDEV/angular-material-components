...
export class DemoFileInputComponent implements OnInit {
  ...
  code1 = `npm install --save @cahdev-angular-material-components/file-input`;

  code2 = `import { NgxMatFileInputModule } from '@cahdev-angular-material-components/file-input';
